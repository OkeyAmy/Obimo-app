  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: tabBarHeight }]}>
      <View style={styles.header}>
        <ThemedText style={styles.headerTitle}>Nearby</ThemedText>
      </View>
      
      <View style={styles.emptyState}>
        <View style={styles.iconContainer}>
          <MaterialCommunityIcons name="map-marker-radius" size={64} color={ObimoColors.textSecondary} />
        </View>
        <ThemedText style={styles.emptyTitle}>No nomads nearby</ThemedText>
        <ThemedText style={styles.emptySubtitle}>
          Enable location to discover fellow travelers in your area.
        </ThemedText>
      </View>
    </View>
  );
